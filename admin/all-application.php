...
<html lang="en">
    <head>
        ...
        <title>Cold Storage Management System || All Application</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">All Application</h1>
                   ...
                   <th>Name</th>
                    ...
                    <th>Application Date</th>
                     <th>Action</th>
                                    ...
                                    <tbody>
                                        <?php $query=mysqli_query($con,"select tblapplication.ID as appid,tblapplication.ApplicationNumber,tblapplication.Status,tblapplication.ApplyDate,tbluser.FirstName,tbluser.LastName,tbluser.MobileNumber,tbluser.Email  from tblapplication join tbluser on tbluser.ID=tblapplication.UserID");
$cnt=1;
