...
$query=mysqli_query($con,"update tblpage set PageTitle='$pagetitle',Email='$email',MobileNumber='$mno',PageDescription='$pagedes' where  PageType='contactus'");
if ($query) {
...
<html lang="en">
    <head>
        ...
        <title>Cold Storage Management System | | Contact Us</title>
