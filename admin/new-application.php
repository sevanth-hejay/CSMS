...
<html lang="en">
    <head>
        ...
        <title>Cold Storage Management System || New Application</title>
                   ...
                   <th>Name</th>
                    ...
                    <th>Application Date</th>
                     <th>Action</th>
                                    ...
                                    <tbody>
                                        <?php $query=mysqli_query($con,"select tblapplication.ID as appid,tblapplication.ApplicationNumber,tblapplication.Status,tblapplication.ApplyDate,tbluser.FirstName,tbluser.LastName,tbluser.MobileNumber,tbluser.Email  from tblapplication join tbluser on tbluser.ID=tblapplication.UserID where tblapplication.Status is null");
$cnt=1;
