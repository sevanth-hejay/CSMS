     ...
     <div class="container py-lg-5 py-md-4">
         ...
         <div class="contacts12-main mb-5">
             ...
             <form action="" method="post" name="changepassword" onsubmit="return checkpass();">
                 ...
                 <div class="main-input">
                     <div class="d-grid">
                      <strong>Current Password:</strong>
                         ...
                         <input type="password" class="contact-input" id="currentpassword" name="currentpassword" value="" required="true">
                         <strong>New Password:</strong>
                         <input type="password" class="contact-input" id="newpassword" name="newpassword" value="" required="true">
                     </div>
                     <div class="d-grid">
                      <strong>Confirm Password:</strong>
                         <input type="password" class="contact-input" id="confirmpassword" name="confirmpassword" value=""  required="true">
                 ...
                 <div class="text-left">
                     <button type="submit" class="btn btn-secondary btn-theme2" name="submit">Change</button></div>
